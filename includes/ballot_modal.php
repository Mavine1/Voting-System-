    ...
    <div class="modal-dialog">
        <div class="modal-content" style="background-color: #ffffff; color: #1e40af; font-size: 15px; font-family: Times;">
            <div class="modal-header" style="border-bottom: 2px solid #1e40af;">
                <button type="button" class="btn btn-close btn-curve pull-right" data-dismiss="modal" aria-label="Close" style="background-color: #ef4444; color: #ffffff; border: none;">
...
<div class="modal fade" id="platform">
    <div class="modal-dialog">
        <div class="modal-content" style="background-color: #ffffff; color: #1e40af;">
            <div class="modal-header" style="border-bottom: 2px solid #1e40af;">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="background-color: #ef4444; color: #ffffff; border: none; padding: 8px 12px;">
                    <span aria-hidden="true">&times;</span>
                </button>
                <h4 class="modal-title" style="color: #1e40af; font-weight: bold;">
            ...
            <div class="modal-footer" style="border-top: 2px solid #1e40af;">
                <button type="button" class="btn btn-default btn-flat pull-left" style="background-color: #1e40af; color: #ffffff; border: none;" data-dismiss="modal">
                    <i class="fa fa-close"></i> Close
                </button>
            </div>
        </div>
