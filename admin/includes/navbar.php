<header class="main-header" style="background-color:#1e40af" >
  ...
  <a href="#" class="logo " style="background-color: #1e40af">
    ...
    <span class="logo-lg " style="background-color:#1e40af ;color:white ; font-size: 22px; font-family:Times  "><marquee behavior="scroll" direction="left">Online Voting System</marquee></span>
